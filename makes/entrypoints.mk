# Scope: repository makes entrypoints and curated wrapper targets.
...
.PHONY: help _internal-list _internal-explain _internal-surface _internal-lint-make _internal-make-drift-report checks-effect checks-group checks-pure checks-tag clean doctor kind-down kind-reset kind-status kind-up makes-target-list openapi-generate registry-doctor release-plan release-verify root-surface-explain k8s-render k8s-validate lint-make stack-up stack-down suites-list tests-all
