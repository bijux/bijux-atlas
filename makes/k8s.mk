...
# Public targets: ops-k8s-tests, ops-k8s-contracts, ops-k8s-smoke
SHELL := /bin/sh
PROFILE ?= kind
...
ops-k8s-contracts: ## Validate k8s contracts through control plane
	@$(DEV_ATLAS) ops k8s conformance --profile $(PROFILE) --allow-subprocess --format $(FORMAT)

ops-k8s-smoke: ## Run k8s smoke checks through control plane
	@$(DEV_ATLAS) ops k8s smoke --profile $(PROFILE) --allow-subprocess --format $(FORMAT)

.PHONY: ops-k8s-tests ops-k8s-contracts ops-k8s-smoke
