...
help:
	@printf '%s\n' \
	  ...
	  'ops:' \
	  '  ops-up ops-down ops-reset ops-clean ops-env-print ops-publish ops-publish-medium ops-deploy ops-offline ops-perf ops-multi-registry ops-ingress ops-warm ops-soak ops-smoke ops-metrics-check ops-traces-check ops-k8s-tests ops-k8s-template-tests ops-load-prereqs ops-load-smoke ops-load-full ops-drill-store-outage ops-drill-overload ops-drill-memory-growth ops-drill-corruption ops-drill-pod-churn ops-drill-upgrade ops-drill-rollback ops-upgrade-drill ops-rollback-drill ops-realdata ops-report ops-script-coverage ops-shellcheck ops-kind-version-check ops-k6-version-check ops-helm-version-check ops-kubectl-version-check ops-tool-check ops-tools-check ops-values-validate ops-openapi-validate ops-dashboards-validate ops-alerts-validate ops-observability-validate ops-observability-smoke ops-obs-up ops-obs-down ops-release-matrix ops-baseline-policy-check ops-ci ops-ci-nightly ops-perf-prepare-store ops-perf-e2e ops-perf-nightly ops-perf-cold-start ops-perf-cold-start-prefetch-5pods ops-perf-compare-redis ops-perf-suite e2e-local e2e-k8s-install-gate e2e-k8s-suite e2e-perf e2e-realdata observability-check layout-check layout-migrate' \
	  'release/surface:' \
