...
legacy/list: ## Print legacy inventory (targets/scripts/docs/config/env) and write evidence JSON
	@python3 ./scripts/areas/layout/legacy_inventory.py --format text --json-out artifacts/evidence/legacy/inventory.json

legacy/check: ## Enforce legacy policy (owner/classification/no-new; optional purge gate)
...
.PHONY: legacy/list legacy/check
