...
internal-list: ## Print internal make targets for maintainers
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/list_internal_targets.py
...
evidence/check: ## Validate evidence JSON schema contract for generated outputs
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/evidence_check.py
...
budgets/check: ## Validate universal budgets and budget-relaxation expiry policy
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/check_ops_budgets.py
...
cleanup/verify: ## One-time cleanup safety verification before deleting legacy paths
	...
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/check_help_snapshot.py && $(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/check_no_dead_entrypoints.py && $(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/check_no_orphan_docs_refs.py && $(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/check_no_orphan_configs.py && $(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/check_no_orphan_owners.py
...
artifacts-index: ## Generate artifacts index for inspection UIs
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/build_artifacts_index.py

artifacts-clean: ## Clean old artifacts with safe retention
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/clean_artifacts.py
...
clean-safe: ## Clean only safe generated make artifact directories
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/clean_make_artifacts.py
...
clean-all: ## Clean all allowed generated dirs (requires CONFIRM=YES)
	...
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/clean_make_artifacts.py --all
...
makefiles-contract: ## Validate makefile contract boundaries and publication rules
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/check_makefiles_contract.py

ci-workflow-contract: ## Validate CI and nightly workflows use canonical make entrypoints
	@$(ATLAS_SCRIPTS) run ./packages/atlasctl/src/atlasctl/checks/layout/check_ci_entrypoints.py
