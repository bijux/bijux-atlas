...
ops-stack-validate: ## Validate stack manifests and formatting drift
	@./packages/atlasctl/src/atlasctl/checks/layout/check_stack_manifest_consolidation.sh
	@./packages/atlasctl/src/atlasctl/checks/layout/check_ops_stack_order.sh
...
ops-kind-cluster-drift-check: ## Require ops contract marker update when cluster profile changes
	@./packages/atlasctl/src/atlasctl/checks/layout/check_kind_cluster_contract_drift.sh
...
ops-script-coverage: ## Validate every ops/**/scripts entrypoint is exposed via make
	@./packages/atlasctl/src/atlasctl/checks/layout/check_ops_script_targets.sh
	@SHELLCHECK_STRICT=1 $(MAKE) ops-shellcheck
	@$(MAKE) -s ops-shfmt
