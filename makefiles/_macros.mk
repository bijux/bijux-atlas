...
with_iso = run_id="$(RUN_ID)"; iso="$(call iso_dir,$(1))"; \
	...
	report_dir="ops/_generated/make/$(1)/$$run_id"; \
	...
	bash -lc '. ./ops/_lib/lane_report.sh; ops_write_lane_report "$(1)" "'"$$run_id"'" "'"$$status"'" "'"$$duration"'" "'"$$log_path"'" "ops/_generated/make" >/dev/null'; \
	[ "$$status" = "pass" ]
