...
fn identifier_strategy() -> impl Strategy<Value = String> {
    let charset = prop_oneof![
        ...
        Just('m'), Just('n'), Just('o'), Just('p'), Just('q'), Just('r'),
        Just('s'), Just('t'), Just('u'), Just('v'), Just('w'), Just('x'),
        Just('y'), Just('z'), Just('0'), Just('1'), Just('2'), Just('3'),
        Just('4'), Just('5'), Just('6'), Just('7'), Just('8'), Just('9'),
        Just('-'), Just('_')
    ];
