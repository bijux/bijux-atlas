...
All notable changes to **bijux-atlas-server** are documented in this file.
...
- Added direct Cargo install and verification guidance for the published server
  binary.
...
- Reframed the server boundary around the deployed HTTP process rather than the
  historical monolithic runtime crate.
