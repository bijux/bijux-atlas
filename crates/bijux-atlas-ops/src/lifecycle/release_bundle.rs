...
pub fn build_release_evidence_tarball(
    repo_root: &Path,
    manifest: &serde_json::Value,
...
pub fn tarball_contains_entry(tarball: &Path, entry_name: &str) -> Result<bool, String> {
...
pub fn tarball_member_checksums(tarball: &Path) -> Result<BTreeMap<String, String>, String> {
