...
- [Strict ordering rules](internal/ordering-rules.md)
- [Optional fields policy](internal/optional-fields.md)
- [What is NOT in model](not-in-model.md)
- [Compatibility with bijux-dna](internal/compat-bijux-dna.md)
