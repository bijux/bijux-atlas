...
All notable changes to **bijux-atlas-model** are documented in this file.
...
- Rewrote crate-facing documentation so model types read as a durable data
  boundary instead of incidental shared structs.
