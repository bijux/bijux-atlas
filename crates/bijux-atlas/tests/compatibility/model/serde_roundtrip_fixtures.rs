...
fn backward_compatibility_fixtures_from_v0_1_parse() {
    let manifest: ArtifactManifest =
        serde_json::from_str(&fixture("tests/fixtures/model/v0_1/artifact_manifest.json"))
            .expect("manifest fixture");
    assert_eq!(manifest.model_version, ModelVersion::V1);

    let catalog: Catalog = serde_json::from_str(&fixture("tests/fixtures/model/v0_1/catalog.json"))
        .expect("catalog fixture");
