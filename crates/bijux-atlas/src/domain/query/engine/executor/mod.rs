...
use super::db::{assert_index_usage, build_sql, order_mode_for, parse_row_from_sql};
use super::filters::{self, GeneQueryRequest, GeneQueryResponse};
    ...
    let next_cursor = if has_more {
        ...
        let payload = match order_mode {
            OrderModeInner::Region => CursorPayloadInner {
                ...
                last_seen: Some(super::cursor::CursorLastSeen {
