...
fn main() {
    println!("cargo:rerun-if-env-changed=BIJUX_ATLAS_VERSION_OVERRIDE");
    ...
    println!(
        "cargo:rustc-env=BIJUX_ATLAS_BUILD_SEMVER_VERSION={}",
        metadata.semver_version
    );
    println!(
        "cargo:rustc-env=BIJUX_ATLAS_BUILD_DISPLAY_VERSION={}",
