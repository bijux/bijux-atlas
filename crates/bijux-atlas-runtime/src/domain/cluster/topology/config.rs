...
use crate::domain::cluster::coordination::distributed::{
...
impl NodeConfigFile {
    ...
    pub fn to_descriptor(&self) -> NodeDescriptor {
        NodeDescriptor {
            ...
            shutdown: crate::domain::cluster::coordination::distributed::ShutdownPolicy {
...
mod tests {
    ...
    fn cluster_config_loader_accepts_example_contract() {
        let path = repo_root().join("configs/examples/operations/runtime/cluster-config.json");
    ...
    fn node_config_loader_accepts_example_contract() {
        let path = repo_root().join("configs/examples/operations/runtime/node-config.json");
