...
use super::super::{artifact_commands, output, IngestCliArgs, OutputMode, ShardingPlanCli};
use super::super::{
...
pub(crate) fn run_ingest(args: IngestCliArgs, output_mode: OutputMode) -> Result<(), String> {
    ...
    let ingest_options = IngestOptions {
        ...
        seqid_policy: SeqidNormalizationPolicy::from_aliases(artifact_commands::parse_alias_map(
            &args.seqid_aliases,
        )),
