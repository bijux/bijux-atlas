...
fn human_output_hashes_are_stable_for_static_contract_runs() {
    let cases = [
        (
            ...
            "d56ca945e6a43a701ebd3b309a4bf78485fdb3f7904415af34f721da96e57eca",
        ),
        (
            vec!["contracts", "ops", "--mode", "static", "--format", "human"],
            "30beff404733dd66836b162aeee62a7303eaf9b13749deebd49fd69e5af4f1ec",
        ),
        (
            vec!["contracts", "make", "--mode", "static", "--format", "human"],
            "ca38f2033e3878beaa54146290903681527ad860bfadd7ea628eaf60d4213a68",
        ),
        (
            vec!["contracts", "all", "--mode", "static", "--format", "human"],
            "5c08127fe159052467ed8a0d46384bcc8dca04ed7220883edf7c48dfbd081260",
        ),
    ];
