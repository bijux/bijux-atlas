include!("inventory_contract_integrity_tail_impl.rs");
fn check_ops_inventory_contract_integrity_aggregate_runner(
    ...
    include!("inventory_contract_integrity_authority_checks_block_impl.rs");
    ...
    check_ops_inventory_contract_integrity_tail(
        ctx,
        &mut violations,
        &gates_json,
        &action_ids,
        InventoryContractTailPaths {
            gates_rel,
            owners_rel,
            registry_rel,
            tools_rel,
