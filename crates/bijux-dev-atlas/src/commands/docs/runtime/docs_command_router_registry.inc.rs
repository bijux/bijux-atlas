    ...
    match command {
                crate::cli::DocsRegistryCommand::Build(common) => {
                    ...
                    if common.allow_write {
                        ...
                        let generated_header = "<!-- Generated by: bijux dev atlas docs registry build --allow-write -->\n<!-- Do not edit by hand: regenerate with bijux dev atlas docs registry build --allow-write -->\n\n";
                        let mut crate_governance_md =
                            format!("{generated_header}# Crate Docs Governance\n\n");
                        ...
                        let mut crate_api_table = format!(
                            "{generated_header}# Crate Public API Table\n\n| Crate | Public API Doc |\n|---|---|\n"
                        );
                        ...
                        let mut inventory_md =
                            format!("{generated_header}# Docs Inventory\n\nLicense: Apache-2.0\n\n");
                        inventory_md
                        ...
                        let mut topic_md = format!("{generated_header}# Topic Index\n\n");
                        ...
                        if make_registry_path.exists() {
                            ...
                            let mut generated_make =
                                format!("{generated_header}# Generated Make Targets\n\n");
