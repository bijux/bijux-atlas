...
pub fn run_subprocess_captured(
    ...
    Ok(CommandCapture {
        ...
        stdout: crate::runtime::normalize_line_endings(&String::from_utf8_lossy(&output.stdout)),
        stderr: crate::runtime::normalize_line_endings(&String::from_utf8_lossy(&output.stderr)),
    })
}
