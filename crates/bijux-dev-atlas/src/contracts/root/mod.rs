...
pub fn contract_explain(contract_id: &str) -> String {
    match contract_id {
        ...
        "ROOT-037" => "Editor backup files and ad hoc note clutter are forbidden anywhere in the repo tree.".to_string(),
        ...
        "ROOT-041" => "Governed contract documents are generated from a canonical executable template with stable sections, schema, and gate mapping.".to_string(),
