...
fn stack_contracts() -> Vec<Contract> {
    vec![
        ...
        Contract { id: ContractId("OPS-STACK-010".to_string()), title: "stack profile intent registry contract", tests: vec![TestCase { id: TestId("ops.stack.profile_intent_registry_valid".to_string()), title: "profile intent registry covers stack profiles with deterministic dependency declarations", kind: TestKind::Pure, run: test_ops_stack_010_profile_intent_registry_valid, }] },
        Contract {
