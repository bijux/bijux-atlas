...
pub fn contract_explain(contract_id: &str) -> &'static str {
    match contract_id {
        ...
        "OPS-META-002" => "Ensures ops contracts only read/write ops-local paths unless explicitly allowlisted.",
        ...
        "OPS-E2E-011" => "Ensures scenario runner compatibility registry and spec support matrix are present and valid.",
        "OPS-E2E-012" => "Ensures canonical scenario golden snapshots are committed and parseable.",
        "OPS-E2E-013" => "Ensures scenario result contracts include deterministic run ids and required evidence pointers.",
        "OPS-E2E-014" => "Ensures scenario runner fails fast on missing prerequisites and stays git-metadata independent.",
        "OPS-E2E-015" => "Ensures scenario-to-required-tools registry covers every declared scenario exactly once.",
        "OPS-E2E-016" => "Ensures upgrade and rollback contract definitions and scenario specs are committed and parseable.",
        "OPS-E2E-017" => "Ensures upgrade compatibility table is complete across patch, minor, and rollback transitions.",
        "OPS-E2E-018" => "Ensures scenario runner declares required upgrade before-after and rollback restoration evidence files.",
        "OPS-E2E-019" => "Ensures compatibility lint policy enforces semver major gating for incompatible transitions.",
        "OPS-E2E-020" => "Ensures schema evolution policy aligns with compatible and incompatible schema-change fixtures.",
        "OPS-E2E-021" => "Ensures API evolution policy aligns with incompatible API fixture and tag-boundary golden records.",
        "OPS-E2E-022" => "Ensures rollback baseline fixture and older-version artifact fixture remain structurally valid and linked.",
        "OPS-E2E-023" => "Ensures failure injection catalog is complete with canonical mechanism IDs and expected behavior text.",
        "OPS-E2E-024" => "Ensures failure scenario specification files exist and define required structural fields.",
        "OPS-E2E-025" => "Ensures scenario runner emits deterministic failure evidence file declarations and operator guidance fields.",
        "OPS-E2E-026" => "Ensures failure contracts policy file links required evidence files and required fields for failure scenarios.",
        "OPS-E2E-027" => "Ensures failure evidence policy always requires logs, metrics snapshot, and config snapshot artifacts.",
        "OPS-E2E-028" => "Ensures diagnose command implementation is schema-versioned and enforces explicit sensitive-key redaction policy.",
        "OPS-E2E-029" => "Ensures failure fixture samples exist and parse for corruption, invalid config, missing artifact, and disk-full simulation.",
        ...
        "OPS-K8S-E-004" => "Effect lane contract for keeping kind install coverage in the k8s install matrix.",
        "OPS-K8S-E-005" => "Effect lane contract for keeping rollout safety inputs active.",
        "OPS-K8S-E-006" => "Effect lane contract for recording Helm and kubeconform version evidence.",
        "OPS-HELM-ENV-001" => "Effect lane contract for keeping Helm-emitted ConfigMap env keys inside the runtime allowlist.",
        "OPS-PROFILES-001" => "Effect lane contract for keeping every install profile renderable by Helm.",
