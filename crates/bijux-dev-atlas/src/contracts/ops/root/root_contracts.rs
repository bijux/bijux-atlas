fn ops_markdown_allowed(rel: &str) -> bool {
    ...
    if rel == "ops/k8s/kind/README.md"
        ...
        || rel == "ops/load/artifacts/README.md"
        || rel == "ops/audit/health-dashboard.md"
        || rel == "ops/audit/summary-table.md"
        || rel == "ops/drift/artifacts/drift-visualization-table.md"
        || rel == "ops/e2e/scenarios/goldens/artifact-integrity.summary.md"
        || rel == "ops/evidence/README.md"
        || rel == "ops/observe/dashboards/README.md"
        || rel == "ops/observe/tracing/coverage-summary.md"
        || rel == "ops/report/generated/ops-release-readiness-summary.md"
        || rel == "ops/_templates/spec.md"
        || rel == "ops/_templates/runbook.md"
        || rel == "ops/_templates/policy.md"
        || rel == "ops/_templates/evidence.md"
        || rel == "ops/_templates/stub.md"
