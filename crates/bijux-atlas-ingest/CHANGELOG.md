...
All notable changes to **bijux-atlas-ingest** are documented in this file.
...
- Removed release-note ambiguity by documenting ingest as a crate-owned Atlas
  surface rather than a runtime submodule.
- Removed ambiguity between ingest execution ownership and artifact publication
  ownership.
