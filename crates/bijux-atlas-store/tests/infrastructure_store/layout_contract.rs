...
fn dataset_layout_keys_are_stable() {
    ...
    assert_eq!(dataset_manifest_key(&dataset), "110/homo_sapiens/GRCh38/manifest.json");
    assert_eq!(dataset_sqlite_key(&dataset), "110/homo_sapiens/GRCh38/gene_summary.sqlite");
    assert_eq!(dataset_manifest_lock_key(&dataset), "110/homo_sapiens/GRCh38/manifest.lock");
}
