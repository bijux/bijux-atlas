...
fn ops_render_ci_matches_golden() {
    ...
    let golden = repo_root().join("crates/bijux-atlas-dev/tests/goldens/ops_render_ci.yaml");
...
fn ops_render_kind_matches_golden() {
    ...
    let golden = repo_root().join("crates/bijux-atlas-dev/tests/goldens/ops_render_kind.yaml");
    assert_or_update_golden(&golden, &actual);
}
...
fn ops_render_perf_matches_golden() {
    ...
    let golden = repo_root().join("crates/bijux-atlas-dev/tests/goldens/ops_render_perf.yaml");
    assert_or_update_golden(&golden, &actual);
}
...
fn ops_install_plan_ci_matches_golden() {
    ...
    let golden = repo_root().join("crates/bijux-atlas-dev/tests/goldens/ops_install_plan_ci.json");
    assert_or_update_golden(&golden, &actual);
}
...
fn ops_install_plan_kind_matches_golden() {
    ...
    let golden =
        repo_root().join("crates/bijux-atlas-dev/tests/goldens/ops_install_plan_kind.json");
    assert_or_update_golden(&golden, &actual);
}
...
fn ops_install_plan_perf_matches_golden() {
    ...
    let golden =
        repo_root().join("crates/bijux-atlas-dev/tests/goldens/ops_install_plan_perf.json");
    assert_or_update_golden(&golden, &actual);
}
