...
use bijux_atlas_dev::performance::config::BenchmarkConfig;
use bijux_atlas_dev::performance::dataset::fixture_registry;
use bijux_atlas_dev::performance::harness::{
...
fn benchmark_config_validation_accepts_canonical_units() {
    let config = BenchmarkConfig {
        ...
        isolation: bijux_atlas_dev::performance::config::IsolationConfig {
            cpu_set: "0-3".to_string(),
            memory_limit_mb: 2048,
        },
        reproducibility: bijux_atlas_dev::performance::config::ReproducibilityConfig {
            fixed_seed: 20260304,
            min_repeat_runs: 3,
