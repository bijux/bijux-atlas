...
fn atlas_server_contract_surfaces_live_with_server_owner_crate() {
    ...
    for required in [
        ...
        "crates/bijux-atlas-server/tests/api_delivery_contracts.rs",
        "crates/bijux-atlas-server/tests/api_delivery_observability.rs",
        "crates/bijux-atlas-server/tests/api_delivery_surface.rs",
        "crates/bijux-atlas-server/tests/api_delivery_contract_support/mod.rs",
        "crates/bijux-atlas-server/tests/api_delivery_contracts/advanced_contracts.rs",
        "crates/bijux-atlas-server/tests/api_delivery_contracts/core_route_contracts.rs",
        "crates/bijux-atlas-server/tests/api_delivery_contracts/security_input_resilience.rs",
        "crates/bijux-atlas-server/tests/api_delivery_contracts/sqlite_query_guarantees.rs",
        "crates/bijux-atlas-server/tests/api_delivery_observability/logging_format.rs",
        "crates/bijux-atlas-server/tests/api_delivery_surface/api_surface_snapshots.rs",
        "crates/bijux-atlas-server/tests/api_delivery_surface/endpoints_contract.rs",
        "crates/bijux-atlas-server/tests/api_delivery_surface/key_endpoints_golden.rs",
        "crates/bijux-atlas-server/tests/api_delivery_surface/snapshots/api-surface.responses.v1.json",
    ...
    for forbidden in [
        "crates/bijux-atlas-api/tests/http_contracts.rs",
        "crates/bijux-atlas-api/tests/http_observability.rs",
        "crates/bijux-atlas-api/tests/http_surface.rs",
        "crates/bijux-atlas-api/tests/http_contracts/advanced_contracts.rs",
        "crates/bijux-atlas-api/tests/http_contracts/core_route_contracts.rs",
        "crates/bijux-atlas-api/tests/http_contracts/security_input_resilience.rs",
        "crates/bijux-atlas-api/tests/http_contracts/sqlite_query_guarantees.rs",
        "crates/bijux-atlas-api/tests/http_contracts_support/mod.rs",
        "crates/bijux-atlas-api/tests/http_observability/logging_format.rs",
        "crates/bijux-atlas-api/tests/http_surface/api_surface_snapshots.rs",
        "crates/bijux-atlas-api/tests/http_surface/endpoints_contract.rs",
        "crates/bijux-atlas-api/tests/http_surface/key_endpoints_golden.rs",
        "crates/bijux-atlas-api/tests/http_surface/snapshots/api-surface.responses.v1.json",
