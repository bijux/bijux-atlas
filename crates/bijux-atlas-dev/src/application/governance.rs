...
use bijux_atlas_dev::core::load_registry;
use bijux_atlas_dev::docs::site_output::validate_named_report;
use bijux_atlas_dev::governance_objects::{
...
use bijux_atlas_dev::reference::governance_enforcement;
...
fn normalize_known_command(command: &str) -> String {
    ...
    if let Some(rest) = trimmed.strip_prefix("bijux-atlas-dev ") {
    ...
    match command {
        ...
        GovernanceCommand::Exceptions { command } => match command {
            ...
            GovernanceExceptionsCommand::Validate {
                ...
                let warning_report = serde_json::json!({
                    ...
                    "version": 1,
                    "inputs": {
                        "generator": "bijux-atlas-dev governance exceptions validate",
        ...
        GovernanceCommand::Deprecations { command } => match command {
            GovernanceDeprecationsCommand::Validate {
                ...
                let compat_warnings_report = serde_json::json!({
                    ...
                    "version": 1,
                    "inputs": {
                        "generator": "bijux-atlas-dev governance deprecations validate",
                        "sources": [
        ...
        GovernanceCommand::Breaking { command } => match command {
            GovernanceBreakingCommand::Validate {
                ...
                let summary = serde_json::json!({
                    ...
                    "version": 1,
                    "inputs": {
                        "generator": "bijux-atlas-dev governance breaking validate",
                        "sources": [
                            "configs/sources/governance/governance/deprecations.yaml",
        ...
        GovernanceCommand::Doctor {
            ...
            let report = serde_json::json!({
                ...
                "version": 1,
                "inputs": {
                    "generator": "bijux-atlas-dev governance doctor",
                    "sources": [
                        "configs/sources/governance/governance/exceptions.yaml",
                        "configs/sources/governance/governance/deprecations.yaml",
...
pub(crate) fn run_registry_command(quiet: bool, command: RegistryCommand) -> i32 {
    ...
    match result {
        ...
        Err(err) => {
            let _ = writeln!(io::stderr(), "bijux-atlas-dev registry failed: {err}");
            1
        }
    }
}
