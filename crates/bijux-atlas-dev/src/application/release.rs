        ...
        write_json(
            ...
            &serde_json::json!({
                ...
                "crates": {
                    ...
                    "ops_control_plane": "bijux-atlas-dev"
                },
                "source_files": {
...
fn run_release_sign(args: ReleaseSignArgs) -> Result<(String, i32), String> {
    ...
    let provenance = serde_json::json!({
        "schema_version": 1,
        "generated_by": "bijux-atlas-dev release sign",
...
fn run_release_packet(args: ReleasePacketArgs) -> Result<(String, i32), String> {
    ...
    let packet = serde_json::json!({
        "schema_version": 1,
        "generated_by": "bijux-atlas-dev release packet",
...
fn create_release_manifest(root: &Path, version: &str) -> Result<serde_json::Value, String> {
    ...
    let mut payload = serde_json::json!({
        ...
        "control_plane_version": bijux_atlas_dev::version::runtime_version(),
...
"#;
        ...
        assert!(errors
            .iter()
            .any(|err| err.contains("parent-relative link `../bijux-atlas-dev/README.md`")));
    }
