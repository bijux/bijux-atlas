...
fn checks_ops_retired_artifact_path_references_absent(
    ...
    let allowlist = [
        "ops/CONTRACT.md",
        "crates/bijux-atlas-dev/src/core/checks/ops/ops/inventory_and_artifact_checks.rs",
    ];
    let scan_roots = [
        Path::new("ops"),
        Path::new("crates/bijux-atlas-dev/src"),
        Path::new("docs/bijux-atlas-dev-docs"),
    ];
...
fn checks_ops_runtime_output_roots_under_ops_absent(
    ...
    let runtime_source_roots = [
        ...
        Path::new("crates/bijux-atlas-dev/src/application/ops/runtime_mod"),
    ];
