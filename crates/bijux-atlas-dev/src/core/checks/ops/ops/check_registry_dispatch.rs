pub fn builtin_ops_check_fn(check_id: &CheckId) -> Option<CheckFn> {
    match check_id.as_str() {
        ...
        "checks_crates_bijux_atlas_dev_help_dispatch_present" => {
            Some(check_crates_bijux_atlas_dev_help_dispatch_present)
        }
        ...
        "checks_crates_bijux_atlas_dev_not_umbrella_binary" => {
            Some(check_crates_bijux_atlas_dev_not_umbrella_binary)
        }
