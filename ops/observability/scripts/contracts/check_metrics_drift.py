...
# Inputs: ops metrics contract + artifacts/ops/observability/metrics.prom
# Outputs: artifacts/ops/observability/metrics-drift.md and non-zero on drift violations.
...
SCRAPE = ROOT / "artifacts/ops/observability/metrics.prom"
REPORT = ROOT / "artifacts/ops/observability/metrics-drift.md"
