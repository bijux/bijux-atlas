...
# Inputs: artifacts/ops/observability/metrics.prom and ops/observability/contract/metrics.golden.prom
...
CURRENT = ROOT / "artifacts/ops/observability/metrics.prom"
