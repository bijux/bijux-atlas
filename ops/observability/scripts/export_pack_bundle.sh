...
cp -f "${REPO_ROOT}/ops/observability/grafana/atlas-observability-dashboard.json" "$OUT_DIR/dashboard.json"
cp -f "${REPO_ROOT}/ops/observability/alerts/atlas-alert-rules.yaml" "$OUT_DIR/alerts.yaml"
...
cp -f "${REPO_ROOT}/ops/observability/pack/compose/docker-compose.yml" "$OUT_DIR/docker-compose.yml"
cp -f "${REPO_ROOT}/ops/observability/pack/compose/prometheus.yml" "$OUT_DIR/prometheus.compose.yml"
cp -f "${REPO_ROOT}/ops/observability/pack/compose/otel-collector.yaml" "$OUT_DIR/otel-collector.compose.yaml"
