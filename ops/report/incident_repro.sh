...
cp -f "$ROOT/ops/report/schema.json" "$OUT/ops-report-schema.json" 2>/dev/null || true
...
cp -f "$ROOT/artifacts/ops/observability/metrics.prom" "$OUT/metrics.prom" 2>/dev/null || true
cp -f "$ROOT/artifacts/ops/observability/traces.snapshot.log" "$OUT/traces.snapshot.log" 2>/dev/null || true
cp -f "$ROOT/artifacts/ops/observability/traces.exemplars.log" "$OUT/traces.exemplars.log" 2>/dev/null || true
