...
Use `bijux-atlas-dev ops validate --format json` to validate the current ops surface.

| Error code | Meaning | Remediation |
| --- | --- | --- |
| `REPO-LAW-001` | Executable scripts detected outside governed exceptions. | Move automation into `bijux-atlas-dev` commands and remove tracked scripts. |
