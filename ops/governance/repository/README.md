...
- Schema: `ops/governance/repository/object.json`
- Domain reviews: `ops/governance/repository/domain-review-dates.json`
- Registry mapping: `ops/governance/repository/domain-registry-map.json`
- Coverage baseline: `ops/governance/repository/coverage-baseline.json`
