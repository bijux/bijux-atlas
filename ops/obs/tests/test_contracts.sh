...
python3 "$ROOT/ops/obs/scripts/contracts/check_obs_budgets.py"
python3 "$ROOT/scripts/public/observability/check_alerts_contract.py"
python3 "$ROOT/ops/obs/scripts/contracts/check_endpoint_metrics_coverage.py"
python3 "$ROOT/ops/obs/scripts/contracts/check_endpoint_trace_coverage.py"
python3 "$ROOT/ops/obs/scripts/contracts/check_overload_behavior_contract.py"
