...
- `configs/policy/forbidden-adjectives-allowlist.json`
...
- `configs/policy/shell-network-fetch-allowlist.json`
- `configs/policy/shell-probes-allowlist.json`
...
- `configs/policy/bypass-entries.json`
