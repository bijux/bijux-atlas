...
- `configs/schemas/registry/release-version-policy.schema.json`: schema for validating `version-policy.json`.
- `configs/schemas/registry/release-reproducibility-policy.schema.json`: schema for validating `reproducibility-policy.json`.
