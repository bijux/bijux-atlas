...
verify_shared_manifest_entry "${local_manifest}" ".bijux/shared/bijux-docs" "local repository"
verify_shared_manifest_entry "${local_manifest}" ".bijux/shared/bijux-makes-py" "local repository"
verify_shared_manifest_entry "${local_manifest}" ".bijux/shared/bijux-checks" "local repository"
...
if [[ -f "${std_manifest}" ]]; then
  for dir_rel in .bijux/shared/bijux-docs .bijux/shared/bijux-makes-py .bijux/shared/bijux-checks; do
