...
make-ci-surface-check: ## Compatibility wrapper for workflow surface contracts
	@$(DEV_ATLAS) contract run --mode static --domain make --format $(FORMAT) --include MAKE-CI-001
...
make-include-cycle-check: ## Compatibility wrapper for include graph contracts
	@$(DEV_ATLAS) contract run --mode static --domain make --format $(FORMAT) --include MAKE-INCLUDE-003
