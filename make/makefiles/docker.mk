...
docker-contracts: ## Run static docker contracts via dev-atlas contracts runner
	...
	@$(DEV_ATLAS) contracts docker --mode static --artifacts-root $(DOCKER_CONTRACTS_ARTIFACT_ROOT) | tee $(DOCKER_CONTRACTS_ARTIFACT_ROOT)/console.txt
...
docker-contracts-effect: ## Run effect docker contracts via dev-atlas contracts runner
	...
	@mkdir -p $(DOCKER_CONTRACTS_ARTIFACT_ROOT)
	@$(DEV_ATLAS) contracts docker --mode effect --allow-subprocess --allow-network --artifacts-root $(DOCKER_CONTRACTS_ARTIFACT_ROOT) | tee $(DOCKER_CONTRACTS_ARTIFACT_ROOT)/console.txt
