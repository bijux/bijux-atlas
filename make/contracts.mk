...
# Public targets: contract, contract-effect, contract-all, contract-list, contract-report, contracts, contracts-pr, contracts-merge, contracts-release, contracts-fast, contracts-changed, contracts-json, contracts-ci, contracts-root, contracts-repo, contracts-crates, contracts-runtime, contracts-configs, contracts-configs-required, contracts-docs, contracts-docs-required, contracts-make, contracts-make-required, contracts-ops, contracts-help, contracts-group, contracts-tag, contracts-pure, contracts-effect
...
.PHONY: _contracts_guard contract contract-effect contract-all contract-list contract-report contracts-help contracts contracts-pr contracts-merge contracts-release contracts-changed contracts-ci contracts-configs contracts-crates contracts-docs contracts-effect contracts-fast contracts-group contracts-json contracts-make contracts-make-required contracts-merge contracts-ops contracts-pr contracts-pure contracts-release contracts-repo contracts-root contracts-runtime contracts-tag
