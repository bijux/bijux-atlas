...
from bijux_atlas_scripts.core.env_guard import ensure_within_repo, guard_no_network_mode
from bijux_atlas_scripts.core.git import read_git_context
from bijux_atlas_scripts.core.models import ContractsIndexModel, OwnershipModel, SurfaceModel
...
from bijux_atlas_scripts.core.yaml_utils import validate_yaml_required_keys
...
def test_find_repo_root_from_nested_path() -> None:
    nested = ROOT / "packages" / "bijux-atlas-scripts" / "src"
