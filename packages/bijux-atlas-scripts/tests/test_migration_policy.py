...
from bijux_atlas_scripts.cli import main as cli_main
from bijux_atlas_scripts.core.scan import iter_python_files
...
def test_no_hidden_imports_do_not_touch_network(monkeypatch) -> None:
    ...
    from bijux_atlas_scripts import cli, contracts, docs, layout, make, ops, report  # noqa: F401
