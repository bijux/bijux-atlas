...
CHECKS: tuple[CheckDef, ...] = (
    ...
    CheckDef("docs.new_command_workflow", "docs", "require docs/tests updates when command registry changes", 600, check_docs_new_command_workflow, fix_hint="Update docs index, pyproject, and tests for command-surface changes.", effects=("fs_read", "subprocess")),
