...
def check_policies_bypass_files_scoped(repo_root: Path) -> tuple[int, list[str]]:
    ...
    for base in scan_roots:
        ...
        for path in base.rglob("*"):
            ...
            if rel.startswith("configs/policy/") or rel.startswith("configs/docs/") or rel.startswith("configs/ops/") or rel.startswith("configs/_schemas/") or rel.startswith("configs/layout/") or rel.startswith("configs/make/") or rel.startswith("configs/repo/") or rel.startswith("configs/security/") or rel.startswith("ops/_artifacts/") or rel.startswith("ops/_lint/") or rel.startswith("ops/_meta/") or rel.startswith("ops/schema/") or rel.startswith("ops/vendor/layout-checks/") or rel.startswith("packages/atlasctl/src/atlasctl/checks/layout/makefiles/policies/") or rel.startswith("packages/atlasctl/src/atlasctl/checks/layout/ops/runtime/") or rel.startswith("packages/atlasctl/src/atlasctl/commands/ops/lint/policy/"):
                continue
...
CHECKS: tuple[CheckDef, ...] = (
    ...
    CheckDef("make.help_determinism", "make", "ensure deterministic make help output", 4000, check_make_help, fix_hint="Regenerate and normalize make help output."),
