...
from atlasctl.checks.tools.ops_domain.contracts import check_ops_external_tools_manifest_native


def main() -> int:
    code, errors = check_ops_external_tools_manifest_native(ROOT)
    if errors:
