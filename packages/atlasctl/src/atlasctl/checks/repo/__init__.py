...
CHECKS: tuple[CheckDef, ...] = (
    ...
    CheckDef("repo.no_python_caches_committed", "repo", "forbid committed python caches under packages/atlasctl", 1000, check_repo_no_python_caches_committed, fix_hint="Remove tracked __pycache__/.pyc/.pytest_cache files and keep them ignored."),
    CheckDef("repo.generated_dirs_policy", "repo", "enforce canonical generated dirs list", 600, check_generated_dirs_policy, fix_hint="Keep generated dirs to canonical locations (docs/_generated, ops/_generated, ops/_generated_committed, artifacts/*)."),
    ...
    CheckDef("repo.ops_configs_newline_policy", "repo", "enforce LF-only and no trailing whitespace in ops/configs text files", 500, check_ops_configs_deterministic_newlines, fix_hint="Normalize files to LF and remove trailing whitespace."),
    CheckDef("repo.no_large_binary_files", "repo", "forbid large tracked binary files except approved fixtures", 800, check_no_large_binary_files, fix_hint="Store large binaries outside git or document approved fixture exceptions."),
    ...
    CheckDef("repo.json_output_deterministic_policy", "repo", "enforce deterministic json.dumps sort_keys policy", 300, check_json_output_deterministic_policy, fix_hint="Use core/runtime/serialize.dumps_json or pass sort_keys=True to json.dumps."),
