...
CHECKS: tuple[CheckDef, ...] = (
    ...
    CheckDef("docker.tag_contract_no_latest", "docker", "docker tag contract forbids latest tags", 1200, check_no_latest_tags, fix_hint="Pin image tags to immutable versions."),
