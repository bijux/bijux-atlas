...
CHECKS: tuple[CheckDef, ...] = (
    ...
    CheckDef("repo.no_exec_python_outside_packages", "repo", "forbid executable python outside package boundaries", 1500, check_no_executable_python_outside_packages, fix_hint="Move script into package module or remove executable bit.", effects=("subprocess",)),
    ...
    CheckDef("repo.no_adhoc_python", "repo", "forbid ad-hoc python files outside package boundaries", 1200, check_no_adhoc_python, fix_hint="Migrate ad-hoc python files into package modules.", effects=("subprocess",)),
    CheckDef("repo.forbidden_adjectives", "repo", "forbid banned wording across tracked repository files", 500, check_forbidden_adjectives, fix_hint="Replace banned wording or add explicit approval entries in configs/policy/forbidden-adjectives-approvals.json.", effects=("subprocess",)),
    ...
    CheckDef("repo.generated_dirs_policy", "repo", "enforce canonical generated dirs list", 4000, check_generated_dirs_policy, fix_hint="Keep generated dirs to canonical locations (docs/_generated, ops/_generated, ops/_generated.example, artifacts/*)."),
    CheckDef("repo.tmp_paths_under_artifacts", "repo", "forbid committed tmp paths outside artifacts/", 800, check_tmp_paths_outside_artifacts, fix_hint="Move tmp paths under artifacts/ or rename to a durable path.", effects=("subprocess",)),
    ...
    CheckDef("repo.no_repo_root_path_literals", "repo", "forbid repo-root Path literals outside runtime paths/context", 900, check_no_repo_root_path_literals, fix_hint="Use runtime paths/context instead of Path(\"configs/...\"), Path(\"ops/...\"), etc."),
    ...
    CheckDef("repo.script_help_coverage", "repo", "validate script help contract coverage", 1500, check_script_help, fix_hint="Add --help contract output to required scripts.", effects=("subprocess",)),
    ...
    CheckDef(DIRECT_SCRIPT_RUNS_CHECK_ID, "repo", DIRECT_SCRIPT_RUNS_DESCRIPTION, 500, run_no_direct_script_runs, fix_hint="Invoke workflows through make targets instead of direct scripts/ops paths.", effects=("subprocess",)),
    ...
    CheckDef("repo.no_path_cwd_usage", "repo", "forbid Path.cwd usage outside core.runtime.repo_root.py", 900, check_no_path_cwd_usage, fix_hint="Use ctx.repo_root or core.runtime.repo_root helpers."),
    ...
    CheckDef("repo.optional_dependency_usage_gates", "repo", "forbid optional dependency usage without explicit allowlist gate", 1400, check_optional_dependency_usage_gates, fix_hint="Move dependency to base deps or add justified exception in configs/policy/dependency-exceptions.json."),
    ...
    CheckDef("repo.internal_import_boundaries", "repo", "forbid atlasctl.internal imports outside internal namespace", 1200, check_internal_import_boundaries, fix_hint="Route shared helpers through public modules instead of atlasctl.internal."),
    CheckDef("repo.modern_no_legacy_imports", "repo", "forbid modern modules from importing " + "atlasctl." + "legacy", 1200, check_no_modern_imports_from_legacy, fix_hint="Migrate callers to canonical modules under atlasctl.core/commands/checks."),
    ...
    CheckDef("repo.modern_no_legacy_obs_imports", "repo", "forbid modern modules from importing " + "atlasctl." + "legacy" + ".obs", 1200, check_no_legacy_obs_imports_in_modern, fix_hint="Migrate observability imports to atlasctl.observability."),
    CheckDef("repo.no_deprecated_namespaces", "repo", "forbid imports from atlasctl.check/report/obs namespaces", 1000, check_forbidden_deprecated_namespaces, fix_hint="Use atlasctl.checks and atlasctl.reporting canonical namespaces."),
    ...
    CheckDef("repo.contract_import_boundaries", "repo", "enforce contracts/core-contracts import boundaries", 1200, check_contract_import_boundaries, fix_hint="Commands/checks should import schema contracts from atlasctl.contracts only."),
    ...
    CheckDef("repo.command_import_lint", "repo", "enforce command module import boundaries", 800, check_command_import_lint, fix_hint="Restrict command imports to core/contracts/checks/adapters/commands/cli."),
    ...
    CheckDef("repo.effect_boundaries", "repo", "forbid direct subprocess/fs/env/network effects outside core boundaries", 1200, check_forbidden_effect_calls, fix_hint="Route effects through core.exec/core.process/core.fs/core.runtime.env/core.network."),
    CheckDef("repo.managed_artifact_write_roots", "repo", "enforce managed write roots under artifacts and reject out-of-root writes", 300, check_managed_artifact_write_roots, fix_hint="Keep managed write roots under artifacts/ and route writes through core.fs.", effects=("subprocess",)),
    ...
    CheckDef("repo.subprocess_boundary", "repo", "restrict subprocess imports to core execution boundary", 1400, check_subprocess_boundary, fix_hint="Use core.exec/core.process for subprocess calls."),
    ...
    CheckDef("repo.import_smoke", "repo", "ensure atlasctl package imports in minimal environment", 300, check_import_smoke, fix_hint="Keep top-level imports light and dependency-safe.", effects=("subprocess",)),
