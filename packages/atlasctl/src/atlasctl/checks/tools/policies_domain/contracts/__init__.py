...
from ...repo_domain.native import check_atlas_scripts_cli_contract, check_layout_contract
...
CHECKS: tuple[CheckDef, ...] = (
    CheckDef("contracts.atlasctl_cli", "contracts", "validate atlasctl CLI contract surface", 1200, check_atlas_scripts_cli_contract, category=CheckCategory.CONTRACT, fix_hint="Update CLI contract docs/tests to match behavior.", effects=("fs_read", "subprocess")),
    CheckDef("contracts.layout", "contracts", "validate repository layout contract", 1200, check_layout_contract, category=CheckCategory.CONTRACT, fix_hint="Fix layout violations reported by the contract checker.", slow=True, external_tools=("bash",), effects=("fs_read", "subprocess")),
    ...
    CheckDef("contracts.schema_change_release_notes", "contracts", "enforce schema bump + release notes policy for schema changes", 1200, check_schema_change_release_notes, category=CheckCategory.CONTRACT, fix_hint="Add new versioned schema file and update packages/atlasctl/docs/release-notes.md.", effects=("fs_read", "subprocess")),
