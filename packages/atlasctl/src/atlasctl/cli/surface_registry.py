...
def command_registry() -> tuple[CommandSpec, ...]:
    return (
        ...
        CommandSpec("policy", "policy command alias", ("configs/policy/",), (), ("policy violations",), owner="platform", doc_link="docs/_generated/cli.md", purpose="alias of policies command group", examples=("atlasctl policy bypass list --report json",), aliases=("policies",)),
