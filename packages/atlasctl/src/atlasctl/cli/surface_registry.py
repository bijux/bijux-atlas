...
def command_registry() -> tuple[CommandSpec, ...]:
    return (
        ...
        CommandSpec("run-id", "generate and print run identifiers", ("artifacts/evidence/",), (), ("invalid prefix",), owner="platform", doc_link="docs/_generated/cli.md", effect_level="pure", run_id_mode="not_required", supports_dry_run=False, purpose="emit canonical run ids for make and local lane isolation", examples=("atlasctl run-id --prefix ci",)),
        ...
        CommandSpec("gate", "run gate contracts and lane checks", ("configs/gates/", "artifacts/evidence/"), ("make",), ("gate contract failures",), owner="ops", doc_link="docs/_generated/cli.md", purpose="execute gate policies and lane checks", examples=("atlasctl gate run --preset root --all --report json",), aliases=("gates",)),
        ...
        CommandSpec("make", "make target wrappers and make contract tooling", ("makefiles/", "configs/make/"), ("make",), ("make contract failures",), owner="platform", doc_link="docs/_generated/cli.md", purpose="keep makefiles thin wrappers around atlasctl", examples=("atlasctl make lint --json", "atlasctl make run ci --json")),
        ...
        CommandSpec("packages", "package domain commands", ("packages/",), (), ("package command failures",), owner="platform", doc_link="docs/_generated/cli.md", purpose="manage package-domain inventories and lifecycle", examples=("atlasctl packages --json",)),
        ...
        CommandSpec("deps", "dependency management commands", ("packages/atlasctl/requirements.lock.txt",), ("python3",), ("dependency lock/sync failures",), owner="platform", doc_link="docs/_generated/cli.md", purpose="manage atlasctl dependency lock and environment sync", examples=("atlasctl deps lock --json",)),
        CommandSpec("gen", "artifact generation commands", ("docs/_generated/", "packages/atlasctl/tests/goldens/"), ("python3",), ("artifact generation failures",), owner="platform", doc_link="docs/_generated/cli.md", purpose="generate registries, docs indexes, and golden artifacts", examples=("atlasctl gen goldens",)),
        ...
        CommandSpec("owners", "owner id registry and validation commands", ("configs/meta/owners.json",), (), ("owner metadata drift",), owner="platform", doc_link="docs/_generated/cli.md", purpose="inspect and validate canonical owner ids", examples=("atlasctl owners list", "atlasctl owners validate --json")),
        CommandSpec("install", "installation checks and doctor commands", ("artifacts/evidence/",), ("python3", "git", "make"), ("tooling probes unavailable",), owner="platform", doc_link="docs/index.md", purpose="validate local install prerequisites and toolchain", examples=("atlasctl install doctor --json",)),
        CommandSpec("release", "release readiness checklist commands", ("artifacts/evidence/",), ("python3",), ("release checklist failures",), owner="platform", doc_link="docs/release-process.md", purpose="run shipping gate checklist for releases", examples=("atlasctl release checklist --plan --json",)),
        CommandSpec("fix", "apply repository hygiene and consistency fixes", ("artifacts/",), ("python3",), ("auto-fix command failure",), owner="platform", doc_link="docs/_generated/cli.md", purpose="run controlled fixers for repo hygiene and generated artifacts", examples=("atlasctl fix hygiene --apply",)),
