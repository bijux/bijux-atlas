...
def command_registry() -> tuple[CommandSpec, ...]:
    return (
        ...
        CommandSpec("internal", "internal control-plane group command surface", ("artifacts/evidence/",), (), ("internal group forwarding failure",), owner="platform", doc_link="docs/_generated/cli.md", purpose="group internal and legacy command surfaces", examples=("atlasctl internal legacy --inventory --report json",), stable=False, internal=True),
