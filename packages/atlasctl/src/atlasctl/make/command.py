...
CHECKS: list[MakeCheck] = [
    ...
    _check(
        ...
        "packages/atlasctl/src/atlasctl/layout_checks/check_public_target_descriptions.py",
        "Add concise help descriptions for all public targets.",
    ),
    _check(
        "public-target-aliases",
        "Validate public target aliases",
        "packages/atlasctl/src/atlasctl/layout_checks/check_public_target_aliases.py",
    ...
    _check(
        ...
        "packages/atlasctl/src/atlasctl/layout_checks/check_internal_targets_not_in_docs.py",
        "Replace internal target references in docs with public targets.",
    ),
    _check(
        "makefile-boundaries",
        "Validate makefile target boundaries",
        "packages/atlasctl/src/atlasctl/layout_checks/check_makefile_target_boundaries.py",
        "Keep top-level/public and internal target boundaries strict.",
    ),
    _check(
        "makefiles-contract",
        "Validate makefiles contract",
        "packages/atlasctl/src/atlasctl/layout_checks/check_makefiles_contract.py",
        "Regenerate makefile contract artifacts and align file ownership.",
    ),
    _check(
        "makefiles-headers",
        "Validate makefile header contract",
        "packages/atlasctl/src/atlasctl/layout_checks/check_makefile_headers.py",
        "Add or correct required makefile scope headers.",
    ),
    _check(
        "makefiles-index-drift",
        "Validate makefiles index drift",
        "packages/atlasctl/src/atlasctl/layout_checks/check_makefiles_index_drift.py",
    ...
    _check(
        ...
        "packages/atlasctl/src/atlasctl/layout_checks/check_no_legacy_target_names.py",
        "Rename or delete legacy targets; do not keep compatibility aliases.",
    ),
    _check(
        "root-mk-size-budget",
        "Validate root.mk size budget",
        "packages/atlasctl/src/atlasctl/layout_checks/check_root_mk_size_budget.py",
        "Move lane-specific logic to dedicated makefiles to stay within budget.",
    ),
    _check(
        "root-makefile-hygiene",
        "Validate root makefile hygiene",
        "packages/atlasctl/src/atlasctl/layout_checks/check_root_makefile_hygiene.py",
