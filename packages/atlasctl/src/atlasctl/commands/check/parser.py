...
def configure_check_parser(sub: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    list_parser.add_argument("--domains", action="store_true", help="list domain names only")
    list_parser.add_argument("--tags", action="store_true", help="list tag names only")
    list_parser.add_argument("--suites", action="store_true", help="list suite names only")
...
def configure_checks_parser(sub: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    checks_list.add_argument("--domains", action="store_true", help="list domain names only")
    checks_list.add_argument("--tags", action="store_true", help="list tag names only")
    checks_list.add_argument("--suites", action="store_true", help="list suite names only")
