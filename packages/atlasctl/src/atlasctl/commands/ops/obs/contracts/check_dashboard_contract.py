...
DASH_CONTRACT = ROOT / "ops/obs/contract/dashboard-panels-contract.json"
DASH = ROOT / "ops/obs/grafana/atlas-observability-dashboard.json"
GOLDEN = ROOT / "ops/obs/grafana/atlas-observability-dashboard.golden.json"
