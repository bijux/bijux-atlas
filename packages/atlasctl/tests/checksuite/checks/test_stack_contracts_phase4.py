...
def test_stack_health_report_sample_matches_schema() -> None:
    schema = json.loads((ROOT / "ops/schema/report/stack-health-report.schema.json").read_text(encoding="utf-8"))
...
def test_stack_ports_inventory_sample_matches_schema() -> None:
    schema = json.loads((ROOT / "ops/schema/report/stack-ports-inventory.schema.json").read_text(encoding="utf-8"))
