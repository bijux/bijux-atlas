...
- `all`: checks=38 markers=['docs', 'dev', 'ops', 'policies', 'configs']
- `ci`: checks=251 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=248 markers=['fast']
...
- `local`: checks=248 markers=['fast']
- `ops`: checks=4 markers=['ops']
- `ops-nightly`: checks=7 markers=['ops', 'slow']
- `perf-nightly`: checks=7 markers=['ops', 'slow']
- `policies`: checks=14 markers=['policies']
- `required`: checks=251 markers=['required']
- `required_proof`: checks=251 markers=['required']
