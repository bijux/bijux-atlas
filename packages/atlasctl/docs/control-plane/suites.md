...
- `ci`: checks=265 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=262 markers=['fast']
...
- `required`: checks=265 markers=['required']
- `required_proof`: checks=265 markers=['required']
