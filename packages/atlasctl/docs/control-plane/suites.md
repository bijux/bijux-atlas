...
- `ci`: checks=292 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=289 markers=['fast']
...
- `required`: checks=292 markers=['required']
- `required_proof`: checks=292 markers=['required']
