...
- `all`: checks=56 markers=['docs', 'dev', 'ops', 'policies', 'configs']
- `ci`: checks=296 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=293 markers=['fast']
- `configs`: checks=2 markers=['configs']
- `dev`: checks=0 markers=['dev']
- `docs`: checks=19 markers=['docs']
- `drill-nightly`: checks=10 markers=['ops', 'slow']
- `internal`: checks=0 markers=['internal', 'internal-only']
- `k8s-e2e-nightly`: checks=10 markers=['ops', 'slow', 'kube']
- `local`: checks=293 markers=['fast']
- `ops`: checks=7 markers=['ops']
- `ops-nightly`: checks=10 markers=['ops', 'slow']
- `perf-nightly`: checks=10 markers=['ops', 'slow']
- `policies`: checks=28 markers=['policies']
- `required`: checks=296 markers=['required']
- `required_proof`: checks=296 markers=['required']
- `slow`: checks=3 markers=['slow']
- `stack-nightly`: checks=10 markers=['ops', 'slow']
