...
- `all`: checks=24 markers=['docs', 'dev', 'ops', 'policies', 'configs']
- `ci`: checks=237 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=234 markers=['fast']
...
- `required`: checks=237 markers=['required']
- `required_proof`: checks=237 markers=['required']
