...
- `checks-fast`: checks=503 markers=['check', 'fast']
- `ci`: checks=506 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=503 markers=['fast']
...
- `lint-fast`: checks=503 markers=['fast', 'lint']
- `load-baseline`: checks=85 markers=['load', 'ops', 'slow']
- `load-smoke`: checks=503 markers=['fast', 'load', 'ops']
- `local`: checks=503 markers=['fast']
...
- `repo-hygiene`: checks=511 markers=['fast', 'hygiene', 'repo']
- `required`: checks=506 markers=['required']
- `required_proof`: checks=510 markers=['required']
