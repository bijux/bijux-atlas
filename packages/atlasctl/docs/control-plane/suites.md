...
- `all`: checks=53 markers=['docs', 'dev', 'ops', 'policies', 'configs']
- `ci`: checks=293 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=290 markers=['fast']
...
- `required`: checks=293 markers=['required']
- `required_proof`: checks=293 markers=['required']
