...
- `all`: checks=63 markers=['docs', 'dev', 'ops', 'policies', 'configs']
- `ci`: checks=303 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=300 markers=['fast']
...
- `required`: checks=303 markers=['required']
- `required_proof`: checks=303 markers=['required']
