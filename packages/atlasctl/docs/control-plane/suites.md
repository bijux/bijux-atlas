...
- `ci`: checks=281 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=278 markers=['fast']
...
- `required`: checks=281 markers=['required']
- `required_proof`: checks=281 markers=['required']
