...
- `all`: checks=64 markers=['docs', 'dev', 'ops', 'policies', 'configs']
- `ci`: checks=304 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=301 markers=['fast']
- `configs`: checks=2 markers=['configs']
- `dev`: checks=0 markers=['dev']
- `docs`: checks=19 markers=['docs']
- `drill-nightly`: checks=17 markers=['ops', 'slow']
- `internal`: checks=0 markers=['internal', 'internal-only']
- `k8s-e2e-nightly`: checks=17 markers=['ops', 'slow', 'kube']
- `local`: checks=301 markers=['fast']
- `ops`: checks=14 markers=['ops']
- `ops-nightly`: checks=17 markers=['ops', 'slow']
- `perf-nightly`: checks=17 markers=['ops', 'slow']
- `policies`: checks=29 markers=['policies']
- `required`: checks=304 markers=['required']
- `required_proof`: checks=304 markers=['required']
- `slow`: checks=3 markers=['slow']
- `stack-nightly`: checks=17 markers=['ops', 'slow']
