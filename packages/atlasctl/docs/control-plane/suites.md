...
- `ci`: checks=283 markers=['required']
- `ci-nightly`: checks=3 markers=['slow']
- `ci-pr`: checks=280 markers=['fast']
...
- `required`: checks=283 markers=['required']
- `required_proof`: checks=283 markers=['required']
