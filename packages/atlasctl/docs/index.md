...
- [Bypass Burn-down Snapshot](_generated/bypass-burn-down.md)
...
- [Ops Action Checklist](control-plane/ops-action-checklist.md)
- [Ops Actions Checklist (Legacy Alias)](control-plane/ops-actions-checklist.md)
- [Bypass Removal (Legacy Guide)](control-plane/bypass-removal.md)
- [Shell Policy](control-plane/shell-policy.md)
- [Ops Execution Model](control-plane/ops-execution-model.md)
- [ops/run Deletion Plan](control-plane/ops-run-deletion-plan.md)
- [ops/run Migration Inventory](control-plane/ops-scripts-migration.md)
- [Ops Refactor Playbook](control-plane/ops-refactor-playbook.md)
- [Ops Suites Checklist](control-plane/ops-suites-checklist.md)
- [Ops Taxonomy](control-plane/ops-taxonomy.md)
- [Product CI Lanes](control-plane/product-ci-lanes.md)
- [Product Artifact Retention Policy](control-plane/product-artifact-retention.md)
- [Product Domain](control-plane/product-domain.md)
- [Product Release CI Verification](control-plane/product-release-ci.md)
- [Product Local Release Guide](control-plane/product-release-local.md)
- [Product Release Tag Policy](control-plane/product-release-tag-policy.md)
- [Schema Version Bump Playbook](control-plane/schema-version-bump-playbook.md)
- [Control-Plane Support Policy](control-plane/support-policy.md)
...
- [Legacy Public API Path](public-api.md)
...
- [Legacy Definition](migration/legacy-definition.md)
- [Epic F Hotspots](migration/epic-f-hotspots.md)
- [Epic G Make Thin Wrapper](migration/epic-g-make-thin-wrapper.md)

## Decisions

- [Decisions Index](decisions/INDEX.md)
- [DEC-0001 Control Plane SSOT](decisions/DEC-0001-control-plane-ssot.md)
- [DEC-0002 Dependency Lock Strategy](decisions/DEC-0002-dependency-lock-strategy.md)

## Commands

- [Command Groups](commands/index.md)
- [New Command Workflow](commands/new-command-workflow.md)
- [Docs Group Commands](commands/groups/docs.md)
- [Configs Group Commands](commands/groups/configs.md)
- [Dev Group Commands](commands/groups/dev.md)
- [Ops Group Commands](commands/groups/ops.md)
- [Policies Group Commands](commands/groups/policies.md)
- [Internal Group Commands](commands/groups/internal.md)
