...
| `scripts/areas/check/check-bin-entrypoints.py` | `platform` | `public` | `scripts-lint` |
...
| `scripts/areas/check/check-python-lock.py` | `platform` | `public` | `scripts-check`, `scripts-lint` |
| `scripts/areas/check/check-script-errors.py` | `platform` | `public` | `scripts-check`, `scripts-lint` |
| `scripts/areas/check/check-script-help.py` | `platform` | `public` | `scripts-check`, `scripts-lint` |
| `scripts/areas/check/check-script-ownership.py` | `platform` | `public` | `scripts-check`, `scripts-lint` |
| `scripts/areas/check/check-script-tool-guards.py` | `platform` | `public` | `scripts-check`, `scripts-lint` |
| `scripts/areas/check/check-script-write-roots.py` | `platform` | `public` | `scripts-check`, `scripts-lint` |
| `scripts/areas/check/docker-runtime-smoke.sh` | `platform` | `public` | `docker-smoke` |
| `scripts/areas/check/docker-scan.sh` | `platform` | `public` | `docker-scan` |
...
| `scripts/areas/configs/check_config_ownership.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_configs_readmes.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_docs_links_for_configs.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_duplicate_threshold_sources.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_no_adhoc_versions.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_openapi_snapshot_generated.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_ops_env_usage_declared.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_perf_thresholds_drift.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_root_config_shims.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_slo_sync.py` | `platform` | `public` | `configs-check` |
| `scripts/areas/configs/check_tool_versions_doc_drift.py` | `platform` | `public` | `configs-check` |
...
| `scripts/areas/configs/validate_configs_schemas.py` | `platform` | `public` | `configs-check` |
...
| `scripts/areas/docs/check_adr_headers.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_broken_examples.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_concept_ids.sh` | `docs-governance` | `public` | - |
| `scripts/areas/docs/check_concept_registry.py` | `docs-governance` | `public` | `docs-build` |
...
| `scripts/areas/docs/check_critical_make_targets_referenced.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_doc_filename_style.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_doc_naming.sh` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_docker_entrypoints.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_docs_deterministic.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_docs_freeze_drift.py` | `docs-governance` | `public` | `docs-freeze` |
| `scripts/areas/docs/check_docs_make_only.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_docs_make_only_ops.py` | `docs-governance` | `public` | `ci-docs-make-only-ops` |
| `scripts/areas/docs/check_docs_make_targets_exist.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_duplicate_topics.sh` | `docs-governance` | `public` | `docs-build`, `rename-lint` |
| `scripts/areas/docs/check_example_configs.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_full_stack_page.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_generated_contract_docs.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_index_pages.sh` | `docs-governance` | `public` | `docs-build`, `docs-lint-names` |
| `scripts/areas/docs/check_k8s_docs_contract.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_load_docs_contract.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_make_help_drift.py` | `docs-governance` | `public` | `ci-make-help-drift`, `docs-build` |
| `scripts/areas/docs/check_make_targets_documented.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_make_targets_drift.py` | `docs-governance` | `public` | `docs-build`, `ops-make-targets-doc` |
| `scripts/areas/docs/check_mkdocs_site_links.py` | `docs-governance` | `public` | - |
| `scripts/areas/docs/check_nav_order.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_no_legacy_root_paths.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_no_orphan_docs.py` | `docs-governance` | `public` | `docs-build`, `docs-lint-names` |
| `scripts/areas/docs/check_no_placeholders.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_observability_acceptance_checklist.py` | `docs-governance` | `public` | - |
| `scripts/areas/docs/check_observability_docs_checklist.py` | `docs-governance` | `public` | `docs-build`, `docs-lint-names` |
| `scripts/areas/docs/check_observability_surface_drift.py` | `docs-governance` | `public` | `ops-observability-validate` |
| `scripts/areas/docs/check_openapi_examples.py` | `docs-governance` | `public` | `docs-build`, `ops-api-smoke`, `ops-openapi-validate` |
| `scripts/areas/docs/check_ops_doc_duplication.py` | `docs-governance` | `public` | `ci-ops-doc-duplication` |
| `scripts/areas/docs/check_ops_docs_make_targets.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_ops_observability_links.py` | `docs-governance` | `public` | `docs-build` |
...
| `scripts/areas/docs/check_runbooks_contract.py` | `docs-governance` | `public` | `docs-build`, `ops-drill-runner` |
| `scripts/areas/docs/check_script_headers.py` | `docs-governance` | `public` | `docs-build`, `scripts-audit`, `scripts-lint` |
...
| `scripts/areas/docs/check_terminology_units_ssot.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/check_title_case.sh` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/extract_code_blocks.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/generate_architecture_map.py` | `docs-governance` | `public` | `architecture-check`, `docs-build` |
| `scripts/areas/docs/generate_concept_graph.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/generate_crates_map.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/generate_k8s_install_matrix.py` | `docs-governance` | `public` | - |
| `scripts/areas/docs/generate_k8s_values_doc.py` | `docs-governance` | `public` | `docs-build` |
...
| `scripts/areas/docs/generate_make_targets_inventory.py` | `docs-governance` | `public` | `docs-build`, `ops-make-targets-doc` |
| `scripts/areas/docs/generate_makefiles_surface.py` | `docs-governance` | `public` | - |
| `scripts/areas/docs/generate_observability_surface.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/generate_openapi_docs.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/generate_ops_badge.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/generate_ops_contracts_doc.py` | `docs-governance` | `public` | `docs-build`, `ops-contracts-check`, `ops-gen` |
| `scripts/areas/docs/generate_ops_schema_docs.py` | `docs-governance` | `public` | `docs-build`, `ops-contracts-check`, `ops-gen` |
| `scripts/areas/docs/generate_ops_surface.py` | `docs-governance` | `public` | `docs-build`, `ops-contracts-check`, `ops-gen` |
| `scripts/areas/docs/generate_repo_surface.py` | `docs-governance` | `public` | - |
| `scripts/areas/docs/generate_scripts_graph.py` | `docs-governance` | `public` | `scripts-graph` |
...
| `scripts/areas/docs/lint_depth.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/lint_doc_contracts.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/lint_doc_status.py` | `docs-governance` | `public` | `docs-build` |
| `scripts/areas/docs/lint_glossary_links.py` | `docs-governance` | `public` | `docs-build` |
...
| `scripts/areas/docs/run_blessed_snippets.py` | `docs-governance` | `public` | `docs-build` |
...
| `scripts/areas/gen/generate_scripts_readme.py` | `platform` | `public` | `scripts-index` |
...
| `scripts/areas/layout/check_dir_budgets.py` | `repo-surface` | `public` | `layout-check` |
| `scripts/areas/layout/check_duplicate_script_intent.py` | `repo-surface` | `public` | `scripts-lint` |
...
| `scripts/areas/layout/check_make_public_scripts.py` | `repo-surface` | `public` | `no-direct-scripts`, `scripts-audit`, `scripts-lint`, `scripts-test` |
...
| `scripts/areas/layout/check_no_legacy_targets_in_docs.py` | `repo-surface` | `public` | `docs-build` |
| `scripts/areas/layout/check_no_mixed_script_name_variants.py` | `repo-surface` | `public` | `scripts-lint` |
| `scripts/areas/layout/check_no_ops_evidence_writes.py` | `repo-surface` | `public` | `ops-lint` |
...
| `scripts/areas/layout/check_ops_external_entrypoints.py` | `repo-surface` | `public` | `docs-build`, `layout-check` |
...
| `scripts/areas/layout/check_ops_run_entrypoints.py` | `repo-surface` | `public` | `ci-ops-run-entrypoints`, `ops-lint` |
...
| `scripts/areas/layout/check_public_entrypoint_cap.py` | `repo-surface` | `public` | `scripts-lint` |
...
| `scripts/areas/layout/check_script_entrypoints.py` | `repo-surface` | `public` | `scripts-check`, `scripts-test` |
| `scripts/areas/layout/check_script_naming_convention.py` | `repo-surface` | `public` | `scripts-lint` |
| `scripts/areas/layout/check_script_relative_calls.py` | `repo-surface` | `public` | `scripts-audit`, `scripts-lint` |
| `scripts/areas/layout/check_scripts_buckets.py` | `repo-surface` | `public` | `scripts-audit`, `scripts-lint` |
...
| `scripts/areas/layout/check_scripts_top_level.py` | `repo-surface` | `public` | `scripts-check`, `scripts-test` |
...
| `scripts/areas/layout/check_symlink_policy.py` | `repo-surface` | `public` | `configs-check`, `layout-check` |
| `scripts/areas/layout/check_tool_versions.py` | `repo-surface` | `public` | `ops-helm-version-check`, `ops-jq-version-check`, `ops-k6-version-check`, `ops-kind-version-check`, `ops-kubectl-version-check`, `ops-lint`, `ops-yq-version-check` |
...
| `scripts/areas/layout/explain_public_target.py` | `repo-surface` | `public` | `explain`, `what` |
...
| `scripts/areas/layout/graph_public_target.py` | `repo-surface` | `public` | `graph`, `what` |
| `scripts/areas/layout/legacy_audit.sh` | `repo-surface` | `public` | `legacy-audit` |
...
| `scripts/areas/layout/make_report.py` | `repo-surface` | `public` | `lane-status`, `open`, `report`, `rerun-failed`, `root`, `root-local`, `root-local-fast`, `triage` |
...
| `scripts/areas/layout/render_public_help.py` | `repo-surface` | `public` | `gates`, `help`, `help-advanced`, `help-all`, `list` |
...
| `scripts/areas/public/config-drift-check.py` | `platform` | `public` | `config-drift`, `configs-check` |
| `scripts/areas/public/config-print.py` | `platform` | `public` | `config-print` |
| `scripts/areas/public/config-validate.py` | `platform` | `public` | `configs-check` |
...
| `scripts/areas/public/ops-policy-audit.py` | `platform` | `public` | `ops-policy-audit` |
