...
# Inputs: generated docs paths and scripts/contracts/generate_contract_artifacts.py.
...
def main() -> int:
    ...
    subprocess.run(["./scripts/contracts/generate_contract_artifacts.py"], cwd=ROOT, check=True)
