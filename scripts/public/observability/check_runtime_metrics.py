#!/usr/bin/env python3
# owner: operations
# purpose: public wrapper for canonical ops observability contract script check_runtime_metrics.py.
# stability: public
...
# Outputs: same as ops/observability/scripts/contracts/check_runtime_metrics.py.
