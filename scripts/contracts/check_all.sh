...
if ! git diff --quiet -- docs/_generated/contracts crates/bijux-atlas-api/src/generated crates/bijux-atlas-server/src/telemetry/generated ops/observability/contract/metrics-contract.json charts/bijux-atlas/values.schema.json; then
  echo "generated contract artifacts are stale; run scripts/contracts/generate_contract_artifacts.py and commit" >&2
  git --no-pager diff -- docs/_generated/contracts crates/bijux-atlas-api/src/generated crates/bijux-atlas-server/src/telemetry/generated ops/observability/contract/metrics-contract.json charts/bijux-atlas/values.schema.json >&2 || true
  exit 1
fi
