...
"$ROOT/scripts/areas/internal/migrate_paths.sh" --apply
...
"$ROOT/scripts/areas/layout/check_root_shape.sh"
"$ROOT/scripts/areas/layout/check_forbidden_root_names.sh"
"$ROOT/scripts/areas/layout/check_repo_hygiene.sh"
