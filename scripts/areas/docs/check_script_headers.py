...
if idx.exists():
    ...
    required_groups = ['scripts/areas/docs/', 'scripts/areas/public/perf/', 'scripts/areas/public/observability/', 'scripts/areas/fixtures/', 'scripts/areas/release/', 'scripts/areas/layout/', 'scripts/bin/', 'scripts/areas/public/', 'scripts/areas/internal/', 'scripts/areas/tools/']
