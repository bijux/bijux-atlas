...
./scripts/bin/bijux-atlas-scripts run scripts/areas/public/contracts/check_sqlite_indexes_contract.py
./scripts/bin/bijux-atlas-scripts run scripts/areas/public/perf/run_critical_queries.py
