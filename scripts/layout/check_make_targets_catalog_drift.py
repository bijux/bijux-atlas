...
def main() -> int:
    subprocess.run(["python3", "scripts/docs/generate_make_targets_catalog.py"], cwd=ROOT, check=True)
    ...
    if diff.returncode != 0:
        ...
        print("- run: python3 scripts/docs/generate_make_targets_catalog.py", file=sys.stderr)
