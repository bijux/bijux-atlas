...
- Root shape gate: `packages/atlasctl/src/atlasctl/checks/layout/check_root_shape.sh`.
- Forbidden-name gate: `packages/atlasctl/src/atlasctl/checks/layout/check_forbidden_root_names.sh`.
