...
- examples pages generated by `bijux-atlas-dev docs generate examples --allow-write`
- command lists generated by `bijux-atlas-dev docs generate command-lists --allow-write --allow-subprocess`
- schema, OpenAPI, ops, and real-data pages generated by explicit `bijux-atlas-dev docs generate ...` commands
