...
- Full inventory table: `docs/_internal/governance/docs-inventory.csv`.
...
- Source list: `docs/_internal/governance/docs-dead-end-pages.txt`.
...
- Source list: `docs/_internal/governance/docs-broken-links.csv`.
...
- Source list: `docs/_internal/governance/docs-policy-pages-outside-governance.txt`.
- Decision: policy pages should converge into `docs/_internal/governance/` unless they are strict runtime runbooks.
...
- Overlap list: `docs/_internal/governance/docs-operations-reference-overlap.txt`.
...
- Source list: `docs/_internal/governance/docs-uppercase-index-pages.txt`.
...
- Source list: `docs/_internal/governance/docs-development-tooling-pages.txt`.
...
- Decision: keep ADRs and move to `docs/_internal/governance/adrs/` as the canonical policy-decision location.

## Single-Link Support Page Findings

Pages with only one inbound link (candidate support-only pages): `192`.

- Source list: `docs/_internal/governance/docs-single-inbound-pages.txt`.
