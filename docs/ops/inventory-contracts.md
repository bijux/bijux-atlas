...
| `ops/inventory/pins.yaml` | `ops/schema/inventory/pins.schema.json` | `bijux dev atlas ops pins update` | Canonical image and dataset pin SSOT |
...
| `ops/inventory/owner-docs.fragments.json` | `ops/schema/inventory/owner-docs.fragments.schema.json` | `bijux dev atlas ops contracts-index` | Derived owner-doc fragment inventory |
| `ops/inventory/contracts/*.contract.fragment.json` | n/a (fragment contract format) | `bijux dev atlas ops contracts-index` | Structured fragments replacing per-domain free-form contract docs over time |
