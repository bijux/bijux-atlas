...
|---|---|
| Root/layout contract | `packages/atlasctl/src/atlasctl/checks/layout/check_root_shape.sh`, `make layout-check`, `ci-root-layout` |
| Symlink policy | `packages/atlasctl/src/atlasctl/checks/layout/check_symlink_policy.py`, `docs/development/symlinks.md`, `layout-check` |
| Makefile-only workflow execution | `packages/atlasctl/src/atlasctl/checks/layout/check_workflows_make_only.py`, `ci-workflows-make-only` |
...
| Script surface governance | `atlasctl docs script-headers-check`, `packages/atlasctl/src/atlasctl/checks/layout/check_make_public_scripts.py`, `packages/atlasctl/src/atlasctl/checks/layout/check_scripts_buckets.py`, `scripts-audit` |
