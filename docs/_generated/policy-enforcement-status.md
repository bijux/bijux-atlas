...
| `no_network_unit_tests` | `hard` | `scripts/public/no-network-unit-tests.sh` | `network usage in unit tests is forbidden` | `PASS` |
| `policy_relaxations_registry` | `hard` | `scripts/public/policy-audit.py` | `exception {entry['id']} expired on` | `PASS` |
