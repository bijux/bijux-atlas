...
19. Make targets: `docs/reference/make-targets.md` <= `docs/development/make-targets.md`, `docs/_generated/make-targets.md`
...
23. Policy placement: `docs/governance/index.md` <= policy pages currently under `_style`, `operations`, `development/ci`
24. Ops reference tables: `docs/reference/index.md` <= `docs/operations/reference/*.md`
25. Concept registry: `docs/_generated/concept-registry.md` <= `docs/_style/CONCEPT_REGISTRY.md`
...
30. Docs policy sources: `docs/governance/docs-operating-model.md` <= `docs/operations/DOCS_STRUCTURE_FREEZE.md`, `docs/operations/DOCS_CONVERGENCE_POLICY.md`
