...
- Script files under `scripts/`: `342`
- Rust test files: `42`
...
- Forbidden-token hits: `3`
- Non-kebab docs outside allowed exceptions: `24`
- Non-kebab scripts under `scripts/`: `269`
...
- `scripts/areas/layout/check_make_command_allowlist.py`
...
- `packages/bijux-atlas-scripts/src/bijux_atlas_scripts/obs/contracts/check_tracing_contract.py`
