...
Decision records live under `docs/governance/decisions/`.

- [ADR-0001: Governance authority boundaries](decisions/adr-0001-governance-authority-boundaries.md)
- [ADR-0002: Automation engine boundary](decisions/adr-0002-automation-engine-boundary.md)
- [ADR-0003: User and dev CLI separation](decisions/adr-0003-user-and-dev-cli-separation.md)
