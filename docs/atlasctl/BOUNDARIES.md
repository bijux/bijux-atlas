...
- Allowed write roots are repository-governed output locations only (for example `artifacts/`, `docs/_generated/`, `ops/_generated.example/`, and other roots explicitly allowed by policy checks).
