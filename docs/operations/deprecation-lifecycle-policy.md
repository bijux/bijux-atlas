...
Contract checks and docs links must stay active during the full grace period.
Removal is allowed only after verification that migration guidance is complete and tested.
