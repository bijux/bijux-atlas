...
- `ops/observability/scripts/drill_*.sh` -> noun-led scenario names
  - Examples:
...
- `docs/_drafts/canonical-transcript-policy-v2-placeholder.md` -> `docs/_drafts/transcripts-canonical-policy.md`
  - Reason: draft status instead of version placeholder naming.
...
- Snapshot naming clarity:
  - `ops/fixtures/medium/golden_queries.json` -> `ops/fixtures/medium/api-list-queries.v1.json`
  - `ops/fixtures/medium/golden_snapshot.json` -> `ops/fixtures/medium/api-list-responses.v1.json`
